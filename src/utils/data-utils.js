...
/**
 * Count the number of properties in an object with the value `TRUE`
 *
 * @param {Object<{[key:string]:boolean}>} data object to be counted
 *
 * @returns {number} Number of items in the object that are `TRUE`
 */
export const getTrueCount = (data) => {
  let total = 0;
 ...
 *
 * @param {object|string} obj  Object or string to be tested
