...
import GenericModal from '../atoms/GenericModal.vue';
import ModalContent from '../atoms/ModalContent.vue';
import GenericModalButtons from '../atoms/GenericModalButtons.vue';
...
const props = defineProps({
  /**
   * @property {string} action Action the modal is describing.
   *
   * * 'save'
   * * 'save-confirm'
   * * 'delete-confirm'
