...
const props = defineProps({
  ...
  /**
   * Type of temporal field
   *
   * Options:
   * * `date` (default) Normal HTML5 date input field
   * * `3date` Custome three input day, month, year fields
   * * `time` Normal HTML5 time input field
   * * `datetime` Normal HTML5 datetime-local input field
   *
  ...
  /**
   * A number (in days) that specifies the granularity the value must
   * adhere to
   *
   * (See: [date - step (MDN)](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/date#step)
   * [datetime-local - step (MDN)](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/datetime-local#step)
   * [time - step (MDN)](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input/time#step))
   *
...
const allowedModes = new Set(['date', 'time', 'datetime', '3date']);
